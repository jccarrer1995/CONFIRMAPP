...
function ReportDetailDrawer({ report, isOpen, onClose }) {
  ...
  return (
    <>
      <div className="report-detail-drawer-overlay" onClick={handleClose}></div>
      <div className={`report-detail-drawer-content ${isClosing ? 'closing' : ''}`}>
